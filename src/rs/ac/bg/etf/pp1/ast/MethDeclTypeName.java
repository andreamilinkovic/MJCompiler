...
public class MethDeclTypeName implements SyntaxNode {
    ...
    public MethDeclTypeName (MethodReturnType MethodReturnType, String methodName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethDeclTypeName(\n");
